...
# Faz as operações e salva corretamente
...
output_path = r"D:\Search\dashboard_python\03 Automatizando Tarefas com Python\0. Onboarding\Excel com Python\formula.xlsx"
output_photo = r"D:\Search\dashboard_python\03 Automatizando Tarefas com Python\0. Onboarding\Excel com Python\catlogo.png"
...
# Use a versão atualizada da API
print(wb.sheetnames)
sheet = wb['Sheet1']
